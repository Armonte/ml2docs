...
```
menu/
„¥„Ÿ„Ÿ menu.hpp                    # Main interface (25 lines)
„¥„Ÿ„Ÿ impl/
„    „¥„Ÿ„Ÿ menu_refactored.cpp    # New main implementation (~100 lines)
„    „¥„Ÿ„Ÿ performance.h/cpp      # Performance monitoring
„    „¥„Ÿ„Ÿ palette_system.h/cpp   # Palette manipulation
„    „¥„Ÿ„Ÿ sprite_system.h        # Sprite system (needs .cpp)
„    „¥„Ÿ„Ÿ ui_utils.h/cpp         # UI utilities
„    „¥„Ÿ„Ÿ controller_config.h/cpp # Controller configuration
„    „¥„Ÿ„Ÿ box.h/cpp              # Box system (existing)
„    „¥„Ÿ„Ÿ vse.h/cpp              # VSE system (existing)
„    „¤„Ÿ„Ÿ character_info.h       # Character data (existing)
```
